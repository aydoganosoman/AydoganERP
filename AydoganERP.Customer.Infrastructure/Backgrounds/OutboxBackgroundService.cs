...
using AydoganERP.Customer.Application.Outboxes_Inboxes.OutboxManager.Commands.UpdateResult;
using AydoganERP.Customer.Application.Outboxes_Inboxes.OutboxManager.Queries.GetAllUnDone;
using MediatR;
