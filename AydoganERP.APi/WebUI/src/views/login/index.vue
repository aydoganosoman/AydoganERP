...
const { locale, translationTr, translationCh, translationEn } = useTranslationLang();
      ...
      <el-dropdown trigger="click">
        ...
        <template #dropdown>
          <el-dropdown-menu class="translation">
            <el-dropdown-item
              :style="getDropdownItemStyle(locale, 'tr')"
              :class="['dark:text-white!', getDropdownItemClass(locale, 'tr')]"
              @click="translationTr"
            >
              <IconifyIconOffline
                v-show="locale === 'tr'"
