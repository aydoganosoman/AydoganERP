...
public static class IQueryableExtensions
{
    ...
    public async static Task<PaginatedList<T>> ToPagedListAsync<T>(this IQueryable<T> source, int currentPage, int pageSize, string sortOn, string sortDirection)
    {
        return await PaginatedList<T>.CreateAsync(source, currentPage, pageSize, sortOn, sortDirection);
    }
